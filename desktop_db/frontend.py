...
def update_command():
    backend.update_selected(title_text.get(),author_text.get(),year_text.get(),isbn_text.get(),selected_tuple[0])
    view_command()

def delete_command():
    #row_delete=get_selected_row()
    backend.delete_selected(selected_tuple[0])
    view_command()
